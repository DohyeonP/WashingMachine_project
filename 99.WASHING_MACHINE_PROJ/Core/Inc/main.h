...
#define LED_DEHYDRATION_Pin GPIO_PIN_14
#define LED_DEHYDRATION_GPIO_Port GPIOF
#define LED_WASHING_MACHINE_Pin GPIO_PIN_15
#define LED_WASHING_MACHINE_GPIO_Port GPIOF
#define IN2_DC_MOTOR_Pin GPIO_PIN_7
#define IN2_DC_MOTOR_GPIO_Port GPIOE
#define IN1_DC_MOTOR_Pin GPIO_PIN_8
#define IN1_DC_MOTOR_GPIO_Port GPIOE
#define BUTTON3_Pin GPIO_PIN_10
#define BUTTON3_GPIO_Port GPIOE
#define BUTTON2_Pin GPIO_PIN_12
#define BUTTON2_GPIO_Port GPIOE
#define LED_RINSING_Pin GPIO_PIN_13
#define LED_RINSING_GPIO_Port GPIOE
